...
CREATE OR REPLACE VIEW public.complete_commission
 AS
  SELECT co.commission_id,
	...
	row_to_json("invoiceAttachment") as "invoiceAttachment"
   FROM commission co
     ...
     LEFT JOIN "Attachment" "invoiceAttachment" ON co.commission_id = "invoiceAttachment".commission_id AND "invoiceAttachment".type = 'INVOICE'::"AttachmentType" AND "invoiceAttachment".deleted = false
 ...
 SELECT invoice.invoice_id,
    ...
    invoice."paidAmount",
        CASE
            ...
            ELSE jsonb_build_object('user_id', "paidStateChangedByUser".user_id, 'number', "paidStateChangedByUser".number, 'email', "paidStateChangedByUser".email, 'name', "paidStateChangedByUser".name, 'surname', "paidStateChangedByUser".surname)
        END AS "paidStateChangedBy",
    "paidStateChangedByUser".user_id AS "paidStateChangedBy_id",
